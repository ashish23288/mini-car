...
class Inventory {
	...
	public function getUnsoldRecords(){
		try{
			$query = 'SELECT a.manufacturer_name,b.model_name, COUNT(b.model_id) as count FROM '.$this->table1.' a LEFT JOIN '.$this->table2.' b ON a.m_id = b.manufacturer_id WHERE status="N" group by b.model_name order by b.model_id';
